...
data class ExecutedCall(val name: String, val args: dev.localintelligence.core.model.ToolArgs)

/** A call the validator refused before execution. */
data class RejectedCall(val name: String, val args: dev.localintelligence.core.model.ToolArgs, val observation: String)
...
data class CompletedRun(
    ...
    private fun canonicalArgs(args: dev.localintelligence.core.model.ToolArgs): String =
