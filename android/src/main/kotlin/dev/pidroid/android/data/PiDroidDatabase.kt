...
/**
 * The PiDroid database. Four tables — `sessions`, `messages`, `memories`,
...
@TypeConverters(PiDroidTypeConverters::class)
abstract class PiDroidDatabase : RoomDatabase() {
    ...
    companion object {
        const val NAME: String = "pidroid.db"

        /**
         * On-disk PiDroid database.
         *
         ...
         */
        fun build(context: Context, name: String = NAME): PiDroidDatabase =
            Room.databaseBuilder(context.applicationContext, PiDroidDatabase::class.java, name)
...
fun PiDroidDatabase.memoryStore(): RoomMemoryStore = RoomMemoryStore(memoryDao())

fun PiDroidDatabase.sessionStore(): RoomSessionStore =
